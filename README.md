...
The packages in the `clpe` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --ros-distro foxy --track foxy clpe` on `Thu, 09 Jun 2022 22:16:56 -0000`

The `clpe` package was released.

Version of package(s) in repository `clpe`:
